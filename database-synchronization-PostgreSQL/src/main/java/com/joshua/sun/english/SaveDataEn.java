    ...
    public static void saveData(String fileName, String url, String username, String password) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            ...
            for (String tableName : tableNames) {
                Map<String, Map<String, Object>> table = FetchDataEn.fetchTableStructure(connection, tableName);
                HashSet<String> PKs = FetchDataEn.fetchPrimaryKeys(connection, tableName);
